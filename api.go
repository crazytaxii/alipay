...
const (
	...
	TRANSFER_2_ACCOUNT = "alipay.fund.trans.toaccount.transfer" // 单笔转账到支付宝账号
	TRANSFER_QUERY     = "alipay.fund.trans.order.query"        // 查询转账订单
)

// 公共请求参数
type (
	CommonRequestParam struct {
